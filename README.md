...
- `styles.css`: layout, calendar styling, target, weekend, holiday, and responsive behavior.
- `app.js`: OOT data, holiday data, target dates, conflict logic, ranking, and rendering.
